...
"${CMAKE_C_FLAGS_DEBUG} ${CC_STD_FLAG} ${CXX_OMP_FLAG} ${CC_WARN_FLAG} -O0 -g -DDASH_RELEASE --coverage -fprofile-arcs -ftest-coverage")
set(CMAKE_CXX_FLAGS_PROFILE
"${CMAKE_CXX_FLAGS_DEBUG} ${CXX_STD_FLAG} ${CXX_OMP_FLAG} ${CC_WARN_FLAG} -O0 -g -DDASH_RELEASE --coverage -fprofile-arcs -ftest-coverage")
...
if (ENABLE_ASSERTIONS)
  ...
  set(CMAKE_C_FLAGS_PROFILE
      "${CMAKE_C_FLAGS_PROFILE} -DDASH_ENABLE_ASSERTIONS -DDART_ENABLE_ASSERTIONS")
  set(CMAKE_CXX_FLAGS_PROFILE
      "${CMAKE_CXX_FLAGS_PROFILE} -DDASH_ENABLE_ASSERTIONS -DDART_ENABLE_ASSERTIONS")
endif()

# Do NOT use CMAKE_BUILD_TYPE=coverage as this will place coverage flags
# before openmp flag. This is not allowed for new versions of gcc

message(STATUS "CC  flags (debug):   ${CMAKE_C_FLAGS_DEBUG}")
message(STATUS "CXX flags (debug):   ${CMAKE_CXX_FLAGS_DEBUG}")
message(STATUS "CC  flags (profile): ${CMAKE_C_FLAGS_PROFILE}")
message(STATUS "CXX flags (profile): ${CMAKE_CXX_FLAGS_PROFILE}")
