...
set(ENVIRONMENT_TYPE "default" CACHE STRING
    "Specify environment setup type. See folder config for available environment setups")
...
if (NOT "${ENVIRONMENT_TYPE}" STREQUAL "")
  ...
  set(ENVIRONMENT_CONFIG_PATH "${CMAKE_SOURCE_DIR}/config/${ENVIRONMENT_TYPE}.cmake")
...
if (NOT "${ENVIRONMENT_CONFIG_PATH}" STREQUAL "")
  if (NOT EXISTS ${ENVIRONMENT_CONFIG_PATH})
    message(FATAL_ERROR
            "Environment configuration file does not exist: ${ENVIRONMENT_CONFIG_PATH}")
  else()
    message(STATUS "Loading environment configuration from ${ENVIRONMENT_CONFIG_PATH}")
