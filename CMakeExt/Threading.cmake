...
if (ENABLE_THREADING)
    ...
    set(CMAKE_C_FLAGS
        "${CMAKE_C_FLAGS} -pthread -DDART_ENABLE_THREADING -DDART_THREADING_PTHREADS -DDASH_ENABLE_THREADING")
    set(CMAKE_CXX_FLAGS
        "${CMAKE_CXX_FLAGS} -pthread -DDART_ENABLE_THREADING -DDART_THREADING_PTHREADS -DDASH_ENABLE_THREADING")
