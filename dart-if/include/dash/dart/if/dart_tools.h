...
typedef void (*dart_tool_remote_dep_cb_t) (
    uint64_t local_task,
...
int dart_tool_register_task_create (
...
int dart_tool_register_task_end(
    dart_tool_task_end_cb_t cb,
    void* userdata);

int dart_tool_register_task_cancel (
    dart_tool_task_cancel_cb_t cb,
    void *userdata);

int dart_tool_register_task_yield_leave (
    dart_tool_task_yield_leave_cb_t cb,
    void *userdata);

int dart_tool_register_task_yield_resume (
    dart_tool_task_yield_resume_cb_t cb,
    void *userdata);

int dart_tool_register_task_finalize (
    dart_tool_task_finalize_cb_t cb,
    void *userdata);

int dart_tool_register_task_add_to_queue (
    dart_tool_task_add_to_queue_cb_t cb,
    void *userdata);

int dart_tool_register_local_dep (
    dart_tool_local_dep_cb_t cb,
    void *userdata);

int dart_tool_register_remote_dep (
