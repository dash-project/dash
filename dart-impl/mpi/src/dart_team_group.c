  ...
  dart_group_t       * gout)
{
  *gout = NULL;
  ...
  if (g1 == NULL || g2 == NULL) {
    DART_LOG_ERROR("Invalid group argument: %p and %p", (const void*)g1, (const void*)g2);
    return DART_ERR_INVAL;
  }
  ...
  dart_global_unit_t  unitid)
{
  ...
  if (g == NULL) {
    DART_LOG_ERROR("Invalid group argument: %p", (const void*)g);
    return DART_ERR_INVAL;
  }
  ...
  dart_group_t            * gout)
{
  ...
  if (group == NULL) {
    DART_LOG_ERROR("Invalid group argument: %p", (const void*)group);
    return DART_ERR_INVAL;
  }
