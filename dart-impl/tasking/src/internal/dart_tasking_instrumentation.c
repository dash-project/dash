  ...
  const char       *name)
{
    ...
    if (dart_tool_task_create_cb_data.cb) {
          dart_tool_task_create_cb_data.cb((uint64_t) task,
                                           prio,
                                           name,
                                           dart_tool_task_create_cb_data.userdata);
  ...
  dart_thread_t *thread)
{
    if (dart_tool_task_begin_cb_data.cb) {
        dart_tool_task_begin_cb_data.cb((uint64_t) task,
                                        (uint64_t) thread,
  ...
  dart_thread_t *thread)
{
    if (dart_tool_task_end_cb_data.cb) {
        dart_tool_task_end_cb_data.cb((uint64_t) task,
                                      (uint64_t) thread,
  ...
  dart_thread_t *thread)
{
  if (dart_tool_task_cancel_cb_data.cb) {
      dart_tool_task_cancel_cb_data.cb((uint64_t) task,
                                       (uint64_t) thread,
  ...
  dart_thread_t *thread)
{
  if (dart_tool_task_yield_leave_cb_data.cb) {
      dart_tool_task_yield_leave_cb_data.cb((uint64_t) task,
                                            (uint64_t) thread,
  ...
  dart_thread_t *thread)
{
  if (dart_tool_task_yield_resume_cb_data.cb) {
      dart_tool_task_yield_resume_cb_data.cb((uint64_t) task,
                                             (uint64_t) thread,
    ...
    int edge_type)
{
    if (dart_tool_local_dep_cb_data.cb) {
        dart_tool_local_dep_cb_data.cb((uint64_t) task1,
                                       (uint64_t) task2,
                                       memaddr_raw,
                                       unitid,
                                       edge_type,
    ...
    dart_thread_t *thread)
{
    if (dart_tool_task_add_to_queue_cb_data.cb) {
        dart_tool_task_add_to_queue_cb_data.cb((uint64_t) task,
                                               (uint64_t) thread,
    ...
    int edge_type)
{
    if (dart_tool_remote_dep_cb_data.cb) {
        dart_tool_remote_dep_cb_data.cb(local_task,
                                        remote_task,
                                        local_dep_type,
                                        remote_dep_type,
                                        memaddr,
