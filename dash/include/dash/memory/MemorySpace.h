...
struct memory_space_traits
{
  using memory_space_domain_category
          = typename MemSpace::memory_domain_space_category;
  ...
  using is_global             = std::integral_constant<
                                  ...
                                  std::is_same<
                                    ...
                                    memory_space_global_domain_tag
                                  >::value >;
  /**
 ...
 */
template <class MemSpaceDomainCategory>
class MemorySpace
{
 ...
 protected:
   ...
   virtual void_pointer do_allocate(
                          std::size_t bytes,
 ...
 public:
    ...
    */
   bool         is_equal(
                  const MemorySpace & other) const noexcept;
...
template <class MemSpaceDomainCategory>
inline MemorySpace<MemSpaceDomainCategory>::~MemorySpace()
{ }

template <class MemSpaceDomainCategory>
inline bool operator==(MemorySpace<MemSpaceDomainCategory> const & lhs,
                       MemorySpace<MemSpaceDomainCategory> const & rhs)
{
