#ifndef DASH__MEMORY__GLOB_HEAP_COMBINED_PTR_H__INCLUDED
#define DASH__MEMORY__GLOB_HEAP_COMBINED_PTR_H__INCLUDED
...
#endif // DASH__MEMORY__GLOB_HEAP_COMBINED_PTR_H__INCLUDED
