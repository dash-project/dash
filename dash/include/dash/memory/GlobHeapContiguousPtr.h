#ifndef DASH__MEMORY__GLOB_HEAP_CONTIGUOUS_PTR_H__INCLUDED
#define DASH__MEMORY__GLOB_HEAP_CONTIGUOUS_PTR_H__INCLUDED
...
public:
  ...
  /*
   * TODO: Implement rebind to allow for the allocation of different types
   *       than ElementType
   * 
  template <typename U>
  struct rebind {
...
#endif // DASH__MEMORY__GLOB_HEAP_CONTIGUOUS_PTR_H__INCLUDED
