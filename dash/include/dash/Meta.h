...
#define DASH_FUNCTIONAL_CLOSURE_TRAILTS_SPEC_REM_CTOR(...) __VA_ARGS__
#define DASH_FUNCTIONAL_CLOSURE_TRAILTS_SPEC(cv, var, is_var)                 \
  template <typename C, typename R, typename... Args>                         \
  struct closure_traits<R (C::*)(Args... DASH_FUNCTIONAL_CLOSURE_TRAILTS_SPEC_REM_CTOR var) cv> { /* NOLINT */ \
...
DASH_FUNCTIONAL_CLOSURE_TRAILTS_SPEC(const, (, ...), 1)
DASH_FUNCTIONAL_CLOSURE_TRAILTS_SPEC(const, (), 0)
DASH_FUNCTIONAL_CLOSURE_TRAILTS_SPEC(, (, ...), 1)
DASH_FUNCTIONAL_CLOSURE_TRAILTS_SPEC(, (), 0)

#undef DASH_FUNCTIONAL_CLOSURE_TRAILTS_SPEC
#undef DASH_FUNCTIONAL_CLOSURE_TRAILTS_SPEC_REM_CTOR
