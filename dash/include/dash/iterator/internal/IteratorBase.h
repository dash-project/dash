#ifndef DASH__ITERATOR__INTERNAL__ITERATOR_BASE_H__INCLUDED
#define DASH__ITERATOR__INTERNAL__ITERATOR_BASE_H__INCLUDED
...
#endif // DASH__ITERATOR__INTERNAL__ITERATOR_BASE_H__INCLUDED
