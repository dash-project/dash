...
#define DASH__GLOB_MEM_H__INCLUDED
...
public:
  /**
   * Constructor, creates instance of GlobMem with pre-allocated
   * memory space.
   */
  GlobMem(
    dart_gptr_t gbegin,
  ...
  {
    DASH_LOG_TRACE("GlobMem(gbegin,nlocal,team)",
...
#include <dash/GlobUnitMem.h>

#endif // DASH__GLOB_MEM_H__INCLUDED
