...
class OutputStream : public ::dash::io::IOSBase<StreamMode> {
 ...
 public:
  ...
  OutputStream(
      ///
      dash::launch lpolicy, std::string filename,
  ...
  OutputStream()                      = delete;
  OutputStream(const self_t & other)  = delete;
  OutputStream(self_t && other)       = default;
