...
public:
  ...
  typedef enum
  {
    ...
    NetLevel1   = DART_LOCALITY_SCOPE_NETLEVEL1,
    NetLevel2   = DART_LOCALITY_SCOPE_NETLEVEL2,
    NetLevel3   = DART_LOCALITY_SCOPE_NETLEVEL3,
    NetLevel4   = DART_LOCALITY_SCOPE_NETLEVEL4,
    NetLevel5   = DART_LOCALITY_SCOPE_NETLEVEL5,
