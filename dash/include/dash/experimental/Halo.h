...
public:
   ...
   * regions.
   */
  HaloBlockIter(GlobStaticHeap_t & globmem, const PatternT & pattern,
   ...
   * \see DashGlobalIteratorConcept
   */
  const GlobStaticHeap_t & globmem() const
  {
    return _globmem;
  }
...
public:
  HaloBlockView(GlobStaticHeap_t & globmem, const PatternT & pattern, const viewspec_t &  halo_region)
...
public:
   ...
   * by halo semantics.
   */
  HaloBlock(GlobStaticHeap_t & globmem, const PatternT & pattern, const viewspec_t &  view,
