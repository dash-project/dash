...
public:
  ...
  void draw_pattern(std::ostream& os,
		    std::array<int, PatternT::ndim()> coords,
		    int dimx, int dimy)
  {
...
private:
  RGB color(dart_unit_t unit) {
    ...
    switch(unit%8) {
    case 0:
      r=0x00; g=0x72; b=0xBD;
      break;
    case 1:
      r=0xD9; g=0x53; b=0x19;
      break;
    case 2:
      r=0xEB; g=0xB1; b=0x20;
      break;
    case 3:
      r=0x7E; g=0x2F; b=0x8E;
      break;
    case 4:
      r=0x77; g=0xAC; b=0x30;
      break;
    case 5:
      r=0x4D; g=0xBE; b=0xEE;
      break;
    case 6:
      r=0xA2; g=0x14; b=0x2F;
      break;
    case 7:
      r=0x33; g=0x6F; b=0x45;
      break;
    }
