...
int main(int argc, char ** argv)
{
  ...
  if (myid == 0) {
    cout << std::setw(25) << "Number of keys: "
         ...
         << endl
         << std::setw(25) << "Nodes: "
         << std::setw(18) << dash::util::Locality::NumNodes()
         << endl
         << std::setw(25) << "Procs: "
         << std::setw(18) << dash::size()
         << endl;
  }
  ...
  dash::sort(key_array.begin(), key_array.end());
  ...
  if (myid == 0) {
    cout << "-------------------------------------------"
         << endl
         << std::setw(25) << "Time (sec): "
         << std::setw(18) << time_elapsed_usec / (1000*1000)
         << endl
