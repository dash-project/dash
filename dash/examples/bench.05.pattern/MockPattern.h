...
public:
  ...
  dash::local_unit_t unit_at(
    ...
    dash::local_unit_t unit_id{((coords[0] + viewspec[0].offset) / _blocksize)
                          % _nunits};
  ...
  dash::local_unit_t unit_at(
    ...
    return dash::local_unit_t(_nunits-1);
  }
  ...
  inline bool is_local(
    IndexType index,
    dash::local_unit_t unit) const noexcept {
