...
static void callback_on_task_begin(uint64_t task, uint64_t thread, void *userdata) {
  
}

static void callback_on_task_end(uint64_t task, uint64_t thread, void *userdata) {
  
}

static void callback_on_task_cancel(uint64_t task, uint64_t thread, void *userdata) {
}

static void callback_on_task_yield_leave(uint64_t task, uint64_t thread,  void *userdata) {

}

static void callback_on_task_yield_resume(uint64_t task, uint64_t thread,  void *userdata) {

}

static void callback_on_task_finalize(void *userdata) {
}
...
static void callback_on_task_add_to_queue(uint64_t task, uint64_t thread, void *userdata) {
}
